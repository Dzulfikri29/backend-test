                                        ...
                                        <div class="col-xl-12 col-lg-6 col-sm-12">
                                            <div class="sales pr-2 pt-2">
                                                <div class="sales-today mb-2">
                                                    <p class="m-0">Today's
                                                        <span class="primary float-right"><i
                                                                class="ft-arrow-up primary"></i> 6.89%</span>
                                                    </p>
                                                    <div class="progress progress-sm mt-1 mb-0">
...
@section('js')
    ...
    <script>
        ...
        let pusherMap = new Pusher($("#pusher_app_key").val(), {
            cluster: $("#pusher_cluster").val(),
            encrypted: true,
        });

        let channelMap = pusherMap.subscribe("realtime_map");
        channelMap.bind("update_map", function(data) {
            reloadMap();
        });
    </script>
@endsection
